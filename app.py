...
if not is_success:
    ...
    **Is it fair? Can they ghost you with no payment? Are you protected?**
    ...
    ### ⚖️ Disclaimer
    ContractGuard uses AI to analyze contract language, but **does not provide legal advice**.  
    This service is intended to support your review process, not replace professional legal counsel.  
    Use at your own discretion.

    ---

    ### 📄 Privacy Policy
    We respect your privacy. Uploaded contracts are never stored permanently. Only a hashed ID and analysis summary are retained for paid users.  
    We do not collect or share personal information.  
    Payments are securely processed via Stripe.

    ### 📜 Terms of Use
    By using this tool, you agree to:
    - Not upload any content you do not have rights to share.
    - Use this tool for informational purposes only.
    - Accept that all output is generated by AI and may contain errors.

    We reserve the right to limit access or update features without notice.
    """)
